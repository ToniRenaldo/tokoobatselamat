 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     <div class="container">
         ...
         <div class="navbar-header">
             ...
             <a class="navbar-brand" href="<?php echo base_url() . 'welcome' ?>">Toko Obat Selamat</a>
         </div>
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
             <ul class="nav navbar-nav">
                 ...
                 <?php if ($h == '1') { ?>
                     ...
                     <li>
                         <a href="<?php echo base_url() . 'admin/retur' ?>"><span class="fa fa-refresh"></span> Return </a>
                     </li>

                     <li>
                         <a href="<?php echo base_url() . 'admin/barang' ?>"><span class="fa fa-shopping-bag"></span> Barang</a>
                     </li>
                     <li>
                         <a href="<?php echo base_url() . 'admin/suplier' ?>"><span class="fa fa-refresh"></span> Suplier </a>
                     </li>
                     <li>
                         <a href="<?php echo base_url() . 'admin/kategori' ?>"><span class="fa fa-tags"></span> Kategori </a>
                     </li>
                     <li>
                         <a href="<?php echo base_url() . 'admin/laporan' ?>"><span class="fa fa-file"></span> Laporan</a>
                     </li>
                     <li>
                         <a href="<?php echo base_url() . 'admin/pembelian' ?>"><span class="fa fa-shopping-basket"></span> Pembelian</a>
                     </li>
                     <li>
                         <a href="<?php echo base_url() . 'admin/pengguna' ?>"><span class="fa fa-users"></span> Admin</a>
                     </li>
                 <?php } ?>
                 <?php if ($h == '2') { ?>
                     <!--dropdown-->
