    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Return
                    <small>Penjualan (Grosir)</small>
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><small>Cek Data!</small></a>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <footer>
                <div class="row">
                    <div class="col-lg-12">
                        <p style="text-align:center;">Copyright &copy; <?php echo '2022'; ?> </p>
                    </div>
                </div>
                <!-- /.row -->
            </footer>
